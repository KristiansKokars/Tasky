...
@Destination
@Composable
fun TaskScreen(navigator: DestinationsNavigator) {
    TaskScreenContent(navigator = navigator)
}

@Composable
private fun TaskScreenContent(navigator: DestinationsNavigator) {
    Scaffold(
        topBar = {
            AgendaTopBar(
                isEditing = true,
...
private fun TaskScreenPreview() {
    ScreenSurface {
        TaskScreenContent(navigator = EmptyDestinationsNavigator)
    }
}